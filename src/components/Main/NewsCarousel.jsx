...
const NewsCarousel = ({data}) => {
    ...
    const ClickNavigate = (e, title, id) => {
        if (drag) {
            navigate(NEWS_ROUTE + '/' + Translate(title) + '/' + id)
    ...
    return (
                ...
                <Carousel
                    defaultControlsConfig={{
                        nextButtonText:
                            <div className={classes.arrow_slide}>
                ...
                >
                    ...
                    {data.map(m =>
                        <div key={m.id} className={classes.news_slide_content}>
                            <div
                                onMouseUp={(e) => ClickNavigate(e, m.title, m.id)}
                            >
                                <p className={classes.news_date}>
