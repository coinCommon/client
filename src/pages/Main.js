                ...
                <div className={classes.about_black}>
                    <div className={classes.container}>
                        <div className={classes.about_left}>
                            <h2>Немного о нас</h2>
                            <div className={classes.description}>
                                Таким образом новая модель организационной деятельности влечет за собой процесс внедрения и модернизации позиций, занимаемых участниками в отношении поставленных задач.
                            </div>
                            <div className={classes.grid_cells}>
                                <div className={classes.cell}>
                                    <div>
                                        <span>>100</span>
                                        <div>перевозок в неделю</div>
                                    </div>
                                </div>
                                <div className={classes.cell}>
                                    <div>
                                ...
                                <div className={classes.cell}>
                                    <div>
                                        <span>3</span>
                                        <div>дня везем до Москвы и НАО</div>
                                    </div>
                                </div>
                            </div>
                        </div>
